...
class Block {
    ...
    constructor(index, previousHash, timestamp, data, hash, nonce) {
        ...
        this.nonce = nonce;           // 随机数，用于生成哈希or用于挖矿or用于工作量证明的计算器
    }

    // 首先定义的第一个创建区块，这个创建区块的索引为0，没有前一个区块的哈希，时间戳为创建时的时间，数据为创建区块，哈希为创建区块的哈希，nonce为
    static get genesis() {
        return new Block(
            0,
            "0",
            15082700000000,
            "first block",
            "000dc75a315c77a1f9c98fb6247d03dd18ac52632d7dc6a99202fd18109b37cf",
            604
        );
    }
}
